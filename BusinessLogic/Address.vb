...
#Region "Retrieve Overloads"
    ...
    Public Function RetrieveByPatient(ByVal PatientID As Long) As Boolean
        ...
        If PatientID > 0 Then
            sql = "SELECT A.*, W.WardID As WardID1, D.DistrictID As DistrictID1, C.CityID, S1.SuburbID FROM tblAddresses A left outer join tblVillages V on V.VillageID = A.VillageID "
...
#End Region
    ...
    Protected Friend Overridable Sub LoadDataRecord(ByRef Record As Object)
        ...
        With Record
            ...
            mDistrictID = Catchnull(.Item("DistrictID1"), 0)
            mSurburbID = Catchnull(.Item("SuburbID"), 0)
            mWardID = Catchnull(.Item("WardID1"), 0)

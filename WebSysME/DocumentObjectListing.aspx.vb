    ...
    Private Sub cmdSearch_Click(sender As Object, e As EventArgs) Handles cmdSearch.Click
        ...
        Try
            ...
            If cboObjects.SelectedValue > 0 Then
                ...
                If cboObjects.SelectedItem.Text = "Staff" Then

                    sql = GenerateSQL(cboObjects.SelectedItem.Text)

                Else

                    Sql = "SELECT * FROM tblFiles F inner join tblDocumentObjects DO on F.FileID = DO.DocumentID "
